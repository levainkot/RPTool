...
public final class RPTool extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("gdo").setExecutor(new DoCmd(config));
        getCommand("me").setExecutor(new MeCmd(config));
        getCommand("gme").setExecutor(new MeCmd(config));
        getCommand("todo").setExecutor(new TodoCmd(config));
        getCommand("gtodo").setExecutor(new TodoCmd(config));
        getCommand("try").setExecutor(new TryCmd(config));
        getCommand("gtry").setExecutor(new TryCmd(config));
        getCommand("n").setExecutor(new NonRPCmd(config));
        getCommand("gn").setExecutor(new NonRPCmd(config));
